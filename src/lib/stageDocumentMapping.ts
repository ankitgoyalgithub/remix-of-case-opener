...
export const STAGE_HELPER_TEXT_BY_NAME: Record<string, string> = {
  ...
  'Census Validation': 'Reconcile the workforce census against the Ministry of Labour list',
  'MOL Validation': 'Reconcile the workforce census against the Ministry of Labour list',
  'MOL Verification': 'Reconcile the workforce census against the Ministry of Labour list',
